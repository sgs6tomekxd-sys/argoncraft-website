  ...
  return (
    ...
    >
      <div className="md:w-1/2 w-full">
        {/* KLUCZOWA ZMIANA: Obraz ma automatyczną wysokość, aby uniknąć przycinania */}
        <img 
            src={imageUrl} 
            alt={title} 
...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Sekcja Nagłówka */}
      <header className="flex flex-col items-center justify-center min-h-screen text-center p-6 relative">
        ...
        <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="mb-2 animate-pulse">
                <h1 className="text-5xl md:text-7xl font-black font-orbitron tracking-widest uppercase bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 bg-clip-text text-transparent drop-shadow-lg">
                    IP: ARGONCRAFT.PL
                </h1>
            </div>
            <button 
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-bold mb-1">Wersja: 1.21+</p>
            <p className="text-lg md:text-xl text-purple-300 font-semibold mb-8">Tryb: Full Custom Survival + RPG</p>
            <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://vishop.pl/shop/15347/server/14526" target="_blank" rel="noopener noreferrer" className="px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-green-500 to-lime-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-green-500/50 transform transition-all duration-300">
                SKLEP
            </a>
            <a href="https://discord.com/invite/vnEcVcMBzA" target="_blank" rel="noopener noreferrer" className="px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-blue-500/50 transform transition-all duration-300">
                DISCORD
            </a>
            </div>
        </div>
      ...
      <main className="py-20 px-6 bg-black/20 backdrop-blur-md">
        <div className="max-w-7xl mx-auto space-y-24">
            {/* Sekcja Wprowadzająca */}
            <section className="text-center">
                <SectionTitle>Witaj na ArgonCraft.pl!</SectionTitle>
                <p className="max-w-4xl mx-auto text-xl text-gray-300 leading-relaxed bg-gray-900/50 p-6 rounded-xl">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <img src="https://i.imgur.com/lnvgaAG.jpeg" alt="Dungeon 1" className="w-full h-auto rounded-xl shadow-lg transition-transform duration-300 hover:scale-105" loading="lazy" />
                    <img src="https://i.imgur.com/aTm61S5.jpeg" alt="Dungeon 2" className="w-full h-auto rounded-xl shadow-lg transition-transform duration-300 hover:scale-105" loading="lazy" />
                    <img src="https://i.imgur.com/gX2XxoP.jpeg" alt="Dungeon 3" className="w-full h-auto rounded-xl shadow-lg transition-transform duration-300 hover:scale-105" loading="lazy" />
                </div>
            </section>
            ...
            <section>
                ...
                {newPlayerFeatures.map((feature, index) => (
                     <div key={index} className="bg-gray-800/50 p-6 rounded-2xl shadow-lg border border-gray-700/50 text-center transition-transform duration-300 hover:-translate-y-2 backdrop-blur-sm">
                         <img src={feature.imageUrl} alt={feature.title} className="rounded-lg mb-4 w-full h-auto"/>
      ...
      <section className="py-20 bg-black/30">
        <div className="max-w-4xl mx-auto text-center px-6">
            <img src="https://i.imgur.com/v12ZocS.png" alt="ArgonCraft Zapowiedź" className="w-full h-auto max-w-md mx-auto mb-8 rounded-lg shadow-2xl shadow-purple-500/20"/>
            <h2 className="text-4xl md:text-5xl font-bold font-orbitron text-white text-shadow mb-4">To dopiero początek!</h2>
            ...
            <a href="https://discord.com/invite/vnEcVcMBzA" target="_blank" rel="noopener noreferrer" className="inline-block px-10 py-5 text-xl font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-lg hover:scale-105 hover:shadow-purple-500/50 transform transition-all duration-300">
